...
describe("opencode run (non-interactive subprocess)", () => {
  ...
  // The budgets are generous on purpose: spawning the CLI cold (bun has to
  // transpile the whole app) can take tens of seconds on a busy CI runner, and a
  // genuine hang still trips the assertion because the harness kills the child.
  cliIt.concurrent(
